...
M5 Project: Scene Understanding for Autonomous Vehicles" <br/>

## Name of the group 
Team 9 (also known as למלם, pronounced "Lam Lam") <br/>
...
Link to the Overleaf [article](https://www.overleaf.com/read/gdvggkpbcnmd), i.e. the report of the project.  <br/>

## Summary of the two papers 
<a href="https://drive.google.com/open?id=1M0HRZNI0OJJiaiefAOT1j8ABFqY55E2JLAgv--reY1E">VGG</a> and <a href="https://drive.google.com/open?id=1eKTcFKF5oGYx-GdWhsLea28V4AF49iJHj9ZHYdvrcas">SqueezeNet</a> summaries. <br/>
...
It has two parallel sequential processes of convolutional layers of different sizes that allow to capture two different types of information. <br/>
...
<a href="https://drive.google.com/open?id=1YQxsxH6de6iRGwwNZ_ifAmFJf_QR4kFX_DB-YkuoMaM"> Classification results </a> 
...
We boost the performance of the network by using a SPP layer (Spatial Pyramid Pooling) instead of a custom pooling layer in the end of each tower (to concatenate the two towers, their shape must agree). <br/>
...
<a href="https://drive.google.com/open?id=1xdwzScs1yIeNa9y7kvcai-PCpIQG_0BUL5POIirqQiM">Slides Week 2 </a> <br/>	
