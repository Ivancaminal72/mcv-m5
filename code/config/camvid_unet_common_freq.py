...
resize_train                 = (356,468)     # Resize the image during training (Height, Width) or None
resize_valid                 = (356,468)      # Resize the image during validation
resize_test                  = (356,468)      # Resize the image during testing
...
save_results_batch_size      = 1               # Size of the batch
...
lrDecayScheduler_epochs      = [5, 15,30,100]     # List of epochs were decay is applied or None for all epochs
...
LRScheduler_M                = 7500            # Number of iterations/epochs expected until convergence
...
TensorBoard_write_images     = True            # Whether to write model weights to visualize as image in Tensorboard.
...
cb_weights_method                  = 'common_freq_cost'   # Label weight balance [None | 'median_freq_cost' | 'rare_freq_cost']
