...
freeze_layers_from           = 30           # Freeze layers from 0 to this layer during training (Useful for finetunning) [None | 'base_model' | Layer_id]
...
debug_images_test            = 200              # N images for testing in debug mode (-1 means all)
...
crop_size_train              = (360,480)            # Crop size during training (Height, Width) or None
crop_size_valid              = (360,480)            # Crop size during validation
crop_size_test               = (360,480)            # Crop size during testing
