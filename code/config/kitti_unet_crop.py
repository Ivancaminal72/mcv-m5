...
crop_size_train              = (356,468)            # Crop size during training (Height, Width) or None
crop_size_valid              = (356,468)            # Crop size during validation
crop_size_test               = (356,468)            # Crop size during testing
