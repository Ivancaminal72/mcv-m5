...
dataset_name                 = 'TT100K_detection'   #'TT100K_detection' # Dataset name
...
debug_images_valid           = 200             # N images for validation in debug mode (-1 means all)
debug_images_test            = 200             # N images for testing in debug mode (-1 means all)
debug_n_epochs               = 2              # N of training epochs in debug mode

# Batch sizes
batch_size_train             = 36            # Batch size during training
batch_size_valid             = 36            # Batch size during validation
batch_size_test              = 36            # Batch size during testing
