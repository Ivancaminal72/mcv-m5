...
resize_train                 = (230, 640)            # Resize the image during training (Height, Width) or None
resize_valid                 = (230, 640)            # Resize the image during validation
resize_test                  = (230, 640)     # Resize the image during testing
